...
A detailed users guide can be found by following the link below.  It
includes many example use cases, 
...
Automatically generated API documentation for all packages, modules,
and classes in Rabacus can be found by following the link below, 
