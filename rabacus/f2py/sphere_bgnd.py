...
#
        ...
        # check input 
        #-----------------------------------------------
        if rad_src.source_type != 'background':
            msg = 'source type needs to be background'
        ...
        #-----------------------------------------------
        super(SphereBgnd,self).__init__()
        ...
        # do post-calculation
        #-----------------------------------------------
        super(SphereBgnd,self).__post__()
    ...
    def call_fortran_solver( self ):
        ...
        (xH1, xH2, xHe1, xHe2, xHe3, 
         ...
         rabacus_fc.sphere_bgnd.sphere_bgnd_solve( 
             self.Edges, 
             self.nH, 
             self.nHe, 
             self.T, 
